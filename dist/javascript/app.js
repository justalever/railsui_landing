...
%o`, message, error2, detail);
  ...
  // src/javascript/controllers/canvas_controller.js
  var canvas_controller_default = class extends Controller {
    connect() {
      this.trigger();
    }
    trigger() {
      var c = document.getElementById("canvas"), ctx = c.getContext("2d"), cw = c.width = window.innerWidth, ch = c.height = window.innerHeight, points = [], tick = 0, opt = {
        count: 8,
        range: {
          x: 40,
          y: 80
  ...
  // src/javascript/controllers/subscribe_controller.js
  var subscribe_controller_default = class extends Controller {
    go(event) {
  ...
  __publicField(subscribe_controller_default, "targets", ["email"]);

  // src/javascript/app.js
  window.Stimulus = Application.start();
  Stimulus.register("canvas", canvas_controller_default);
  Stimulus.register("subscribe", subscribe_controller_default);
})();
